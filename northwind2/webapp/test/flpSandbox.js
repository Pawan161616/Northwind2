		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#northwindnorthwind2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwindnorthwind2-display": {
								"semanticObject": "northwindnorthwind2",
								"action": "display",
								"description": "Northwind Worklist Application",
								"title": "Northwind Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwind.northwind2",
									"url": sap.ui.require.toUrl("northwind/northwind2")
								}
							}
						}
					}
